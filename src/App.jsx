...
export default function LuminaryPanels() {
  ...
  return (
    <div style={{ width:"100%", overflowX:"hidden" }}>
      ...
      <div style={{ minHeight:"100vh", color:"#f2f2f7", fontFamily:"system-ui,-apple-system,sans-serif", background:"linear-gradient(160deg,#09090b 0%,#0d0d1a 50%,#09090b 100%)", paddingBottom: isMobileView ? 110 : 0 }}>
        ...
        <div style={{ display:"flex", flexWrap:"wrap", justifyContent:"center", gap:20, padding:"20px 14px", maxWidth:1600, margin:"0 auto" }}>
          ...
          <main style={{ flex:"2 1 400px", maxWidth: isMobileView ? "100%" : 660, display:"flex", flexDirection:"column", gap:14, minWidth:0 }}>
            {/* Sticky preview on mobile */}
            <div style={{
              background: cardBg, borderRadius:24,
              padding: isMobileView ? "16px 14px" : "28px 20px",
